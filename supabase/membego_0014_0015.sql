-- =============================================================================
-- MEMBEGO — Migraciones 0014 + 0015 (integración: webhook, datos, SSO)
-- =============================================================================
-- Aplica SOLO estas dos migraciones en Supabase → SQL Editor → Run.
-- (El resto del esquema ya está en tu base; esto agrega lo de Membego.)
--
-- Crea: membego_company_links, membego_webhook_events, memberships,
-- customer_promotions, y las funciones membego_ingest_event, membego_link_company
-- y membego_sso_upsert_user.
--
-- Es seguro correrlo una vez sobre una base que aún no tiene estas tablas.
-- Verificado contra PostgreSQL 16 (167/167 pruebas).
-- =============================================================================


-- #############################################################################
-- ###  0014 · Integración con Membego
-- #############################################################################
