-- ============================================================================
-- PARCHE 0040 · editar y borrar datos, con freno
--
-- Para correr suelto en el SQL Editor de Supabase. Mismo contenido de
-- supabase/migrations/20260817120000_editar_y_borrar.sql y repetible sin daño.
--
-- OJO: recrea once claves ajenas para pasarlas a ON DELETE RESTRICT, y cada una
-- se revalida con un escaneo de su tabla. A este tamaño son segundos, pero
-- conviene correrlo fuera de hora de servicio.
-- ============================================================================
-- ============================================================================
