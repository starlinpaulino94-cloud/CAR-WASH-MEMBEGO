...
-- =============================================================================
-- Reúne las migraciones de supabase/migrations/ EN ORDEN, para aplicarlas de una
-- sola vez desde el editor SQL del panel de Supabase.
--
-- CÓMO EJECUTARLO
...
--
-- REQUISITOS
--   * Proyecto NUEVO/VACÍO. Usa create type/table/trigger sin "if not exists"
--     (falla antes de pisar datos). Para reaplicar, borra el esquema primero.
--   * No incluye el shim de auth: Supabase ya trae auth.users, auth.uid() y los
--     roles anon/authenticated/service_role.
--
-- DESPUÉS
--   * Ejecuta bootstrap_empresa_usuario.sql (empresa + usuario propietario).
--   * Opcional: seed_catalogo_ejemplo.sql (catálogo inicial).
--
-- Verificado contra PostgreSQL 16. Generado a partir de supabase/migrations/.
-- =============================================================================
