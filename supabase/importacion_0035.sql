-- =============================================================================
-- PARCHE 0035 · IMPORTACIÓN MASIVA  ·  Editor SQL de Supabase
-- =============================================================================
-- Ejecútelo DESPUÉS de notas_credito_0034.sql. Pegue el archivo completo y
-- dele «Run».
--
-- Qué instala: la puerta única `import_batch(entidad, filas, aplicar)` y sus
-- conversores. Con `aplicar => false` hace el trabajo entero y lo revierte,
-- devolviendo qué habría pasado; con `aplicar => true` lo conserva. Nunca
-- borra un dato existente, nunca duplica, y no toca la existencia de un
-- producto ya registrado.
--
-- Se puede ejecutar las veces que quiera: solo contiene `create or replace`,
-- no crea tablas ni modifica ninguna. No toca un solo dato del negocio.
--
-- Entidades: clientes, vehiculos, servicios, productos, proveedores,
-- promociones. Quién puede: propietario, administrador y superadmin.
-- =============================================================================
