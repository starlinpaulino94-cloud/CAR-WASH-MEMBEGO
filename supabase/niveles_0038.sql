-- ============================================================================
-- PARCHE 0038 · niveles tarifarios por categoría
--
-- Para correr suelto en el SQL Editor de Supabase si no se aplica por
-- migraciones. Es el mismo contenido de
-- supabase/migrations/20260815120000_niveles_membego.sql y se puede repetir
-- sin daño: todo va con IF NOT EXISTS / OR REPLACE / DROP POLICY IF EXISTS.
-- ============================================================================
-- ============================================================================
