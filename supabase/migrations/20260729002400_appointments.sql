...
create index appointments_branch_day_idx on public.appointments (branch_id, scheduled_at);
create index appointments_company_idx on public.appointments (company_id, scheduled_at desc);
create index appointments_active_idx on public.appointments (branch_id, scheduled_at)
