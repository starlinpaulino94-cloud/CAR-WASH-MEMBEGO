-- =============================================================================
-- PARCHE 0020 (editor SQL de Supabase) · Proveedores y compras
-- =============================================================================
-- Ejecuta este script COMPLETO en el editor SQL (Production), DESPUÉS del
-- parche 0019 (inventario_0019.sql). Es idempotente.
-- Habilita: Inventario → Compras y Proveedores, con cuentas por pagar.
-- =============================================================================
...
create index if not exists purchases_company_time_idx on public.purchases (company_id, purchase_date desc);
create index if not exists purchases_pending_idx on public.purchases (company_id, due_date)
