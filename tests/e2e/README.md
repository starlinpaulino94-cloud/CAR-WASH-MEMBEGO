# Ensayos de extremo a extremo — POS, Caja y Facturas
...
**54 comprobaciones** en dos ensayos (`pos-cash.e2e.mjs` y `invoices.e2e.mjs`).
...
node tests/e2e/invoices.e2e.mjs   # requiere reset.sh previo: siembra sus propios datos
```
