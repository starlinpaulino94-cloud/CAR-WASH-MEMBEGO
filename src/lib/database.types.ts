...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      qc_history_page: {
        Args: { p_from?: string; p_to?: string; p_washer_id?: string; p_result?: string; p_page?: number; p_size?: number };
        Returns: Json;
      };
      orders_page: {
        Args: {
      ...
      profit_report_lines: {
        Args: { p_from: string; p_to: string; p_branch_id?: string | null; p_limit?: number };
        Returns: Json;
      };
      sales_report_lines: {
