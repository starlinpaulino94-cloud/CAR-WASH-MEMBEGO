...
export const initialVehicles: Vehicle[] = [
  {
    ...
    companyId: 'comp-101',
    customerId: 'cust-1',
    customerName: 'Starlin El Tanque',
    plate: 'A982134',
    make: 'Toyota',
...
export const initialWorkOrders: WorkOrder[] = [
  ...
  },
  {
    ...
    customerId: 'cust-1',
    customerName: 'Starlin El Tanque',
    customerPhone: '809-771-4400',
    vehicleId: 'veh-1',
    vehiclePlate: 'A982134',
...
export const initialAuditLogs: AuditLog[] = [
  ...
  },
  {
    ...
    details: 'Membresía validada e IdempotencyKey registrada para Starlin El Tanque (Toyota Prado A982134)',
